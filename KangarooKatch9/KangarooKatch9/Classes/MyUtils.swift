...
func createShadowLabel(font: String, text: String, fontSize: CGFloat, horAlignMode: SKLabelHorizontalAlignmentMode, vertAlignMode: SKLabelVerticalAlignmentMode, labelColor: UIColor, shadowColor: UIColor, name: String,
