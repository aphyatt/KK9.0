...
class Settings: SKScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        let controlSettingLabel: [SKLabelNode] = createShadowLabel("Soup of Justice", text: "Controls:",
            fontSize: 50,
            horAlignMode: .Center, vertAlignMode: .Baseline,
            labelColor: SKColor.blackColor(), shadowColor: SKColor.whiteColor(),
            name: "controlLabel",
        ...
        let thumbLabel: [SKLabelNode] = createShadowLabel("Soup of Justice", text: "ONE HAND",
            fontSize: 30,
            horAlignMode: .Center, vertAlignMode: .Baseline,
            labelColor: SKColor.blackColor(), shadowColor: SKColor.whiteColor(),
            name: "thumbLabel",
        ...
        let twoThumbsLabel: [SKLabelNode] = createShadowLabel("Soup of Justice", text: "TWO HANDS",
            fontSize: 30,
            horAlignMode: .Center, vertAlignMode: .Baseline,
            labelColor: SKColor.blackColor(), shadowColor: SKColor.whiteColor(),
            name: "twoThumbsLabel",
        ...
        let backLabel: [SKLabelNode] = createShadowLabel("Soup of Justice", text: "BACK",
            fontSize: 20,
            horAlignMode: .Center, vertAlignMode: .Baseline,
            labelColor: SKColor.blackColor(), shadowColor: SKColor.whiteColor(),
            name: "backLabel",
    ...
    func sceneTouched(touchLocation:CGPoint) {
        ...
        if(thumbButtonRect.contains(touchLocation)) {
            shade = drawRectangle(thumbButtonRect, color: SKColor.grayColor(), width: 1.0)
            buttonTouched = true
        }
        else if(twoThumbsButtonRect.contains(touchLocation)) {
            shade = drawRectangle(twoThumbsButtonRect, color: SKColor.grayColor(), width: 1.0)
            buttonTouched = true
        }
    ...
    func sceneUntouched(touchLocation:CGPoint) {
        ...
        if (shade != nil) {
            ...
            if(controlChange) {
                let controlChangeLabel: [SKLabelNode] = createShadowLabel("Soup of Justice", text: controlChangeMessage,
                    fontSize: 30,
                    horAlignMode: .Center, vertAlignMode: .Baseline,
                    labelColor: SKColor.blackColor(), shadowColor: SKColor.whiteColor(),
    ...
    func debugDrawPlayableArea() {
        let tShape = drawRectangle(thumbButtonRect, color: SKColor.redColor(), width: 4.0)
        addChild(tShape)
        
        let ttShape = drawRectangle(twoThumbsButtonRect, color: SKColor.redColor(), width: 4.0)
        addChild(ttShape)
